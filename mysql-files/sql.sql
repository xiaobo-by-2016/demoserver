...
AND (u.user_account='201305020443' OR u.user_phone='18428369049') AND u.user_password='12345678';
...
WHERE (u.user_account='201305020445' OR u.user_phone='18428369045') AND u.user_password='12345678';
